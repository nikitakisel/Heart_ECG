...
def main():
    ...
    # show a layout
    curve_calculation.draw_layout(result, maximums, establish_points, small_rectangle_length)
    ...
    for i in range(len(maximums)):
        ...
        cv2.putText(result, maximum_letters[i % 3], (x - 10, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (44, 211, 15), 2)
