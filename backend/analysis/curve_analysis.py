...
def find_neighbour_minimums(
    maximums,
    category_count,
    current_categories,
    potential_neighbour_minimums,
):
    category_maximums = [
        maximums[i]
        for i in range(len(maximums))
        if i % category_count in current_categories
    ]
    neighbour_minimums = []
    ind = 0
    ...
    for i in range(1, len(potential_neighbour_minimums)):
        if (
            potential_neighbour_minimums[i][0] > category_maximums[ind][0]
            and potential_neighbour_minimums[i][1] != category_maximums[ind][1]
        ):
            k = 1
            while (
                potential_neighbour_minimums[i - k][1]
                == category_maximums[ind][1]
            ):
                k += 1
...
def find_neighbour_maximums(
    minimums,
    max_distance,
    potential_neighbour_maximums,
):
    neighbour_maximums = []
    ind = 0
    ...
    for i in range(len(potential_neighbour_maximums)):
        if (
            ind % 2 == 0
            and minimums[ind][0] - potential_neighbour_maximums[i][0]
            <= max_distance
        ):
            ...
            ind % 2 == 1
            and potential_neighbour_maximums[i][0] - minimums[ind][0]
            > max_distance
        ):
